...
public class ResultObj {
	...
	public static final ResultObj  RESET_SUCCESS=new ResultObj(Constast.OK, "修改成功");
	public static final ResultObj  RESET_ERROR=new ResultObj(Constast.ERROR, "修改失败");
    public static final ResultObj  RESET_ERROR_null=new ResultObj(Constast.ERROR, "修改失败,没有id");
    ...
    public static final ResultObj  Select_SUCCESS=new ResultObj(Constast.OK, "查询成功");
    public static final ResultObj  Select_ERROR=new ResultObj(Constast.ERROR, "查询失败");
